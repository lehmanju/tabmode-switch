...
class Extension {
    ...
    enable() {
        ...
        // start socket
        let [success, pid] = GLib.spawn_async(null, "tabmodesw", GLib.SpawnFlags.SEARCH_PATH | GLib.SpawnFlags.DO_NOT_REAP_CHILD, null, null);
        ...
        this.menuItem = new PopupMenu.PopupSwitchMenuItem("Tablem mode", false);
        this.menuItem.connect("toggled", Lang.bind(this, function (item, state) {
            let socketClient = new Gio.SocketClient();
            let conn = socketClient.connect("/tmp/tabmodesw.sock", null);
